...
.controller('BankBaseCtrl', function($scope, $log, Tools, My, UCenter, $state, $ionicHistory, $location, PATH) {
...
.controller('BankController', function($scope, $ionicHistory, $log, Tools, My, UCenter) {
...
.controller('WithdrawController', function($scope, $log, $state, $ionicHistory, My, Tools, UCenter, md5) {
...
.controller('TransController', function($rootScope, $scope, $stateParams, $timeout, $ionicHistory, $ionicModal, Tools, My, $interval) {
...
.controller('DepositController', function($scope, $log, $state, $filter, $ionicHistory, ENV, Tools, UCenter, BankService) {
...
.controller('OnlinePayController', function($scope, $log, $state, $cookies, $filter, $ionicHistory, ENV, Tools, UCenter, BankService) {
	...
	$scope.setFormAction = function(onlinepayData) {
		var formUrl = base_url + "/userrech/onlinePay.do";
...
.controller('OfflinePayController', function($scope, $log, $state, $filter, $ionicHistory, ENV, Tools, UCenter, BankService) {
	var rechType = $state.current.data.rechType;
