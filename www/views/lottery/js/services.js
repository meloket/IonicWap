...
.service('Lottery', function(Tools, $log, $state, $timeout, My) {
	...
	this.getRealStatus = function(callback, game_id, update_time) {
		Tools.ajax({
			url: '/game/getRealtimeStatus.do',
			params: {gameId: game_id, updateTime: update_time},
			success: function(data) {
				callback(data);
			}
	...
	this.getServerCurrenttime = function(callback) {
		Tools.ajax({
			url: '/game/getServerCurrenttime.do',
			success: function(data) {
				callback(data);
			}
	...
	this.getNextIssueJS = function(callback, game_id) {
		Tools.ajax({
			url: '/staticdata/NextIssue.js?gameId=' + game_id,
			params: {
			},
			success: function(data) {
				callback(data);
			...
			error: function(data) {
				console.log("NEXTISSUEJS_ERROR: " + data);
			}
		});
	}

	this.getCurIssueJS = function(callback, game_id) {
		Tools.ajax({
			url: '/staticdata/CurIssue.js?gameId=' + game_id,
			params: {
			},
			success: function(data) {
				callback(data);
			...
			error: function(data) {
				console.log("CURISSUEJS_ERROR: " + data);
			}
		});
	}

	this.getHistoryJS = function(callback, date, game_id) {
		Tools.ajax({
			url: '/staticdata/HistoryLottery.js?dateStr=' + date + '&gameId=' + game_id,
			params: {
			},
			success: function(data) {
				callback(data);
			...
			error: function(data) {
				console.log("HISTORYJS_ERROR: " + data);
			}
		});
	}
